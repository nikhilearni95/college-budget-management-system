...
<div class="panel panel-default">
  ...
  <!--<div class="panel-heading">
    <center>
      <font color="purple" size="4">Consumables required for the academic year</font>
    </center>
  </div>-->
</div>
<div class="panel-heading">
...
<div class="panel-heading">
  ...
  <div class="panel-body">
    <form method="POST" action="storeConsumables.php">
...
<br>
<button type="submit" class="btn btn-primary" value="2" name="submit"> Submit</button>
<div class="clear"></div>
