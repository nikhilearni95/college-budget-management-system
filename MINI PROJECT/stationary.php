...
<div class="panel panel-default">
  ...
  <!--<div class="panel-heading">
    <center>
      <font color="purple" size="4">Stationaries required for the academic year</font>
    </center>
  </div>-->
</div>
...
<nav class="navbar navbar-inverse">
  ...
  <div class="panel-body">
    <form method="POST" action="storeStationary.php">
...
<div class="col-sm-2 nopadding">
  <div class="form-group">
    <input type="text" class="form-control" id="quantity" name="quantity[]" value="" placeholder="Enter Amount Required">
  </div>
</div>
<div class="col-sm-2 nopadding">
  <div class="form-group">
...
function education_fields() {
  ...
  var rdiv = 'removeclass'+room;
    divtest.innerHTML = '<div class="col-sm-12 nopadding m-3"></div><div class="col-sm-4 nopadding"><div class="form-group"><input type="text" class="form-control" id="item_description" name="item_description[]" value="" placeholder="Enter item description"></div></div><div class="col-sm-2 nopadding"><div class="form-group"><input type="text" class="form-control" id="quantity" name="quantity[]" value="" placeholder="Enter Amount Required"></div></div><div class="col-sm-2 nopadding"><div class="form-group"><input type="text" class="form-control" id="item_cost" name="item_cost[]" value="" placeholder="Enter item cost"></div></div><div class="col-sm-3 nopadding"><div class="form-group"><input type="text" class="form-control" id="total" name="total[]" value="" placeholder="Enter total value"></div></div><div class="input-group-btn"> <button class="btn btn-danger" type="button" onclick="remove_education_fields('+ room +');"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button></div><div class="clear"></div><div class="col-sm-12 nopadding"></div>';
